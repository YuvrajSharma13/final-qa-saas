...
const paths: Record<string, string> = {
  ...
  bug: 'M8 9h8M9 5l1.5 2M15 5l-1.5 2M6 13H3M21 13h-3M6 17l-2 2M18 17l2 2M6 9l-2-2M18 9l2-2M8 9a4 4 0 0 1 8 0v6a4 4 0 0 1-8 0zM12 11v7',
  ...
  cursor: 'M4 4l7 17 2.5-7.5L21 11z',
  ...
  stop: 'M6 6h12v12H6z',
  github: 'M9 19c-5 1.5-5-2.5-7-3m14 6v-3.9a3.4 3.4 0 0 0-.9-2.6c3.1-.4 6.4-1.5 6.4-7a5.4 5.4 0 0 0-1.5-3.7 5 5 0 0 0-.1-3.8s-1.2-.3-3.9 1.5a13.4 13.4 0 0 0-7 0C6.3 1.7 5.1 2 5.1 2A5 5 0 0 0 5 5.8a5.4 5.4 0 0 0-1.5 3.7c0 5.4 3.3 6.6 6.4 7a3.4 3.4 0 0 0-.9 2.6V22',
...
export const AGENT_ICON: Record<string, IconName> = {
  test_planner: 'compass',
  functional_qa: 'cursor',
  api_qa: 'plug',
  vision_qa: 'eye',
  bug_analyzer: 'puzzle',
  code_analysis: 'code',
  regression_test: 'repeat',
  orchestrator: 'layers',
};
